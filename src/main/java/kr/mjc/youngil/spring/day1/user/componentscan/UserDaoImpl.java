...
import kr.mjc.youngil.java.jdbc.DbUtils;
import kr.mjc.youngil.java.jdbc.ResultSetHandler;
...
public class UserDaoImpl implements UserDao{
    ...
    public UserDaoImpl(DbUtils dbUtils) {
        ...
        System.out.println("Inject dbUtils into UserDaoImpl using componentScan");
    }
